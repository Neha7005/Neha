...
try:
        # Assuming parsed_args is correctly set up elsewhere in your script
        train_and_evaluate_mlops(config_path=parsed_args.config)
except Exception as e:
        # Print the traceback to see where exactly the error occurred
        traceback.print_exc(file=sys.stdout)
        # You can also log this error to a file or another system for easier debugging
        print(f"Error: {str(e)}")